...
def create_app(test_config=None):
    ...
    def create_or_search_question():
        ...
        if 'searchTerm' not in data:
            # case insert
            if data.get('question', '') == '' or data.get('answer', '') == '':
                abort(400)
    ...
    def get_quiz():
        ...
        if quiz_category_id != 0:
            filtered_questions = Question.query.filter(Question.id.notin_(previous_questions), Question.category == quiz_category_id).all()
        else:
